...
var AutoSizer = function (_React$PureComponent) {
  ...
  function AutoSizer() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = AutoSizer.__proto__ || _Object$getPrototypeOf(AutoSizer)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      return propDebounce ? debounce(_this._onResize, propDebounce) : _this._onResize;
  ...
  _createClass(AutoSizer, [{
    ...
    value: function componentDidMount() {
      ...
      if (this._autoSizer && this._autoSizer.parentNode instanceof HTMLElement) {
        ...
        this._detectElementResize.addResizeListener(this._parentNode, this._resizeHandler());
    ...
    value: function componentWillUnmount() {
      if (this._detectElementResize && this._parentNode) {
        this._detectElementResize.removeResizeListener(this._parentNode, this._resizeHandler);
      }
    }
  }, {
    key: "render",
...
AutoSizer.propTypes = {
  ...
  debounce: require("prop-types").number.isRequired,
